    ...
    <footer className="border-t border-cyan-500/20 bg-slate-950">
      <div className="mx-auto max-w-7xl px-6 py-10 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-4 text-sm">
          <a href="#projects" className="text-cyan-200/80 hover:text-cyan-50">Projects</a>
          <a href="#services" className="text-cyan-200/80 hover:text-cyan-50">Services</a>
          <a href="#skills" className="text-cyan-200/80 hover:text-cyan-50">Skills</a>
          <a href="#about" className="text-cyan-200/80 hover:text-cyan-50">About</a>
